 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mt="WebChannelConnection";class yO extends class{constructor(n){this.databaseInfo=n,this.databaseId=n.databaseId;const r=n.ssl?"https":"http",s=encodeURIComponent(this.databaseId.projectId),i=encodeURIComponent(this.databaseId.database);this.Ao=r+"://"+n.host,this.Ro=`projects/${s}/databases/${i}`,this.Vo=this.databaseId.database==="(default)"?`project_id=${s}`:`project_id=${s}&database_id=${i}`}get mo(){return!1}fo(n,r,s,i,o){const a=Yu(),l=this.po(n,r);G("RestConnection",`Sending RPC '${n}' ${a}:`,l,s);const c={"google-cloud-resource-prefix":this.Ro,"x-goog-request-params":this.Vo};return this.yo(c,i,o),this.wo(n,l,c,s).then(u=>(G("RestConnection",`Received RPC '${n}' ${a}: `,u),u),u=>{throw ci("RestConnection",`RPC '${n}' ${a} failed with error: `,u,"url: ",l,"request:",s),u})}So(n,r,s,i,o,a){return this.fo(n,r,s,i,o)}yo(n,r,s){n["X-Goog-Api-Client"]=function(){return"gl-js/ fire/"+Oi}(),n["Content-Type"]="text/plain",this.databaseInfo.appId&&(n["X-Firebase-GMPID"]=this.databaseInfo.appId),r&&r.headers.forEach((i,o)=>n[o]=i),s&&s.headers.forEach((i,o)=>n[o]=i)}po(n,r){const s=mO[n];return`${this.Ao}/v1/${r}:${s}`}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}wo(e,n,r,s){const i=Yu();return new Promise((o,a)=>{const l=new MN;l.setWithCredentials(!0),l.listenOnce(DN.COMPLETE,()=>{try{switch(l.getLastErrorCode()){case zu.NO_ERROR:const u=l.getResponseJson();G(mt,`XHR for RPC '${e}' ${i} received:`,JSON.stringify(u)),o(u);break;case zu.TIMEOUT:G(mt,`RPC '${e}' ${i} timed out`),a(new H(N.DEADLINE_EXCEEDED,"Request time out"));break;case zu.HTTP_ERROR:const h=l.getStatus();if(G(mt,`RPC '${e}' ${i} failed with status:`,h,"response text:",l.getResponseText()),h>0){let f=l.getResponseJson();Array.isArray(f)&&(f=f[0]);const d=f==null?void 0:f.error;if(d&&d.status&&d.message){const p=function(T){const y=T.toLowerCase().replace(/_/g,"-");return Object.values(N).indexOf(y)>=0?y:N.UNKNOWN}(d.status);a(new H(p,d.message))}else a(new H(N.UNKNOWN,"Server responded with status "+l.getStatus()))}else a(new H(N.UNAVAILABLE,"Connection failed."));break;default:ae()}}finally{G(mt,`RPC '${e}' ${i} completed.`)}});const c=JSON.stringify(s);G(mt,`RPC '${e}' ${i} sending request:`,s),l.send(n,"POST",c,r,15)})}bo(e,n,r){const s=Yu(),i=[this.Ao,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=NN(),a=ON(),l={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},c=this.longPollingOptions.timeoutSeconds;c!==void 0&&(l.longPollingTimeout=Math.round(1e3*c)),this.useFetchStreams&&(l.useFetchStreams=!0),this.yo(l.initMessageHeaders,n,r),l.encodeInitMessageHeaders=!0;const u=i.join("");G(mt,`Creating RPC '${e}' stream ${s}: ${u}`,l);const h=o.createWebChannel(u,l);let f=!1,d=!1;const p=new _O({_o:T=>{d?G(mt,`Not sending because RPC '${e}' stream ${s} is closed:`,T):(f||(G(mt,`Opening RPC '${e}' stream ${s} transport.`),h.open(),f=!0),G(mt,`RPC '${e}' stream ${s} sending:`,T),h.send(T))},ao:()=>h.close()}),v=(T,y,m)=>{T.listen(y,I=>{try{m(I)}catch(E){setTimeout(()=>{throw E},0)}})};return v(h,Ga.EventType.OPEN,()=>{d||G(mt,`RPC '${e}' stream ${s} transport opened.`)}),v(h,Ga.EventType.CLOSE,()=>{d||(d=!0,G(mt,`RPC '${e}' stream ${s} transport closed`),p.To())}),v(h,Ga.EventType.ERROR,T=>{d||(d=!0,ci(mt,`RPC '${e}' stream ${s} transport errored:`,T),p.To(new H(N.UNAVAILABLE,"The operation could not be completed")))}),v(h,Ga.EventType.MESSAGE,T=>{var y;if(!d){const m=T.data[0];Xe(!!m);const I=m,E=I.error||((y=I[0])===null||y===void 0?void 0:y.error);if(E){G(mt,`RPC '${e}' stream ${s} received error:`,E);const R=E.status;let D=function(K){const W=Ke[K];if(W!==void 0)return LT(W)}(R),M=E.message;D===void 0&&(D=N.INTERNAL,M="Unknown error status: "+R+" with message "+E.message),d=!0,p.To(new H(D,M)),h.close()}else G(mt,`RPC '${e}' stream ${s} received:`,m),p.Eo(m)}}),v(a,xN.STAT_EVENT,T=>{T.stat===Im.PROXY?G(mt,`RPC '${e}' stream ${s} detected buffering proxy`):T.stat===Im.NOPROXY&&G(mt,`RPC '${e}' stream ${s} detected no buffering proxy`)}),setTimeout(()=>{p.Io()},0),p}}function Ju(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
