...
`);const r=Number(n.statusCode||500),s=r===404,i=n.statusMessage??(s?"Page Not Found":"Internal Server Error"),o=n.message||n.toString(),a=void 0,u=s?Cg(()=>mt(()=>import("./error-404.295400af.js"),["./error-404.295400af.js","./error-404.7fc72018.css"],import.meta.url).then(h=>h.default||h)):Cg(()=>mt(()=>import("./error-500.902d8183.js"),["./error-500.902d8183.js","./error-500.c5df6088.css"],import.meta.url).then(h=>h.default||h));return(h,f)=>(Cn(),jn(Re(u),RC(TE({statusCode:Re(r),statusMessage:Re(i),description:Re(o),stack:Re(a)})),null,16))}},rH=nH,sH={__name:"nuxt-root",setup(t){const e=()=>null,n=Be(),r=n.deferHydration(),s=!1;Nn(Ia,O0()),n.hooks.callHookWith(a=>a.map(l=>l()),"vue:setup");const i=hu();iE((a,l,c)=>{if(n.hooks.callHook("vue:error",a,l,c).catch(u=>console.error("[nuxt] Error in `vue:error` hook",u)),ox(a)&&(a.fatal||a.unhandled))return n.runWithContext(()=>Vs(a)),!1});const o=!1;return(a,l)=>(Cn(),jn(hd,{onResolve:Re(r)},{default:cd(()=>[Re(i)?(Cn(),jn(Re(rH),{key:0,error:Re(i)},null,8,["error"])):Re(o)?(Cn(),jn(Re(e),{key:1,context:Re(o)},null,8,["context"])):Re(s)?(Cn(),jn(FR(Re(s)),{key:2})):(Cn(),jn(Re(tH),{key:3}))]),_:1},8,["onResolve"]))}},pv=sH;globalThis.$fetch||(globalThis.$fetch=FS.create({baseURL:$S()}));let gv;{let t;gv=async function(){var i,o;if(t)return t;const r=!!((i=window.__NUXT__)!=null&&i.serverRendered||((o=document.getElementById("__NUXT_DATA__"))==null?void 0:o.dataset.ssr)==="true")?Wb(pv):jb(pv),s=ZS({vueApp:r});try{await tP(s,B4)}catch(a){await s.callHook("app:error",a),s.payload.error=s.payload.error||a}try{await s.hooks.callHook("app:created",r),await s.hooks.callHook("app:beforeMount",r),r.mount(wx),await s.hooks.callHook("app:mounted",r),await Dr()}catch(a){await s.callHook("app:error",a),s.payload.error=s.payload.error||a}return r},t=gv().catch(e=>{console.error("Error while mounting app:",e)})}export{sE as $,lg as A,GB as B,Hv as C,XH as D,Td as E,yt as F,DM as G,DH as H,r4 as I,LH as J,Re as K,jn as L,gH as M,VH as N,MH as O,xH as P,AH as Q,NH as R,RH as S,PH as T,SH as U,CH as V,kH as W,hH as X,bH as Y,OR as Z,X4 as _,ws as a,HH as a$,dn as a0,Rp as a1,xr as a2,Yg as a3,la as a4,YD as a5,vH as a6,iS as a7,vB as a8,sj as a9,wB as aA,l4 as aB,oa as aC,Dr as aD,ue as aE,Da as aF,QH as aG,RB as aH,UH as aI,EB as aJ,WH as aK,ej as aL,_H as aM,fH as aN,sa as aO,xn as aP,Ye as aQ,qH as aR,YH as aS,zB as aT,tj as aU,IB as aV,ni as aW,Bv as aX,FR as aY,GH as aZ,qy as a_,ij as aa,zH as ab,nj as ac,c4 as ad,lH as ae,uH as af,yH as ag,KH as ah,un as ai,BH as aj,Mv as ak,Ue as al,sC as am,Ui as an,Nn as ao,fn as ap,nE as aq,tE as ar,nn as as,$H as at,mh as au,FH as av,rj as aw,bc as ax,JH as ay,pH as az,Ac as b,mH as b0,jH as b1,ZH as b2,be as c,rr as d,$t as e,cH as f,lS as g,Ri as h,$E as i,GD as j,Cn as k,dH as l,wE as m,OH as n,gd as o,Pc as p,ye as q,Je as r,cd as s,iH as t,Be as u,IE as v,Oh as w,oH as x,aH as y,kc as z};
